...
/**
 * Enhanced Hero Background — Cinematic, layered, and rich.
 * Uses multiple overlapping gradients, grain texture, and floating particles
 * to create a high-end editorial feel that doesn't feel "empty".
 */
